...
- **Resolution**: Add one of these labels:
...
All merge automation workflows are located in [`.github/workflows/merge-automation/`](.github/workflows/merge-automation/).

### [`approval-labels.yaml`](.github/workflows/merge-automation/approval-labels.yaml)
Handles `/lgtm` and `/approve` commands in PR comments. Manages label addition and removal based on user permissions.

### [`hold-label.yaml`](.github/workflows/merge-automation/hold-label.yaml)
...
### [`wip-label.yaml`](.github/workflows/merge-automation/wip-label.yaml)
...
### [`release-notes-label.yaml`](.github/workflows/merge-automation/release-notes-label.yaml)
...
### [`needs-rebase-label.yaml`](.github/workflows/merge-automation/needs-rebase-label.yaml)
Automatically detects merge conflicts and adds/removes the `needs-rebase` label when conflicts are present.

### [`merge-readiness.yaml`](.github/workflows/merge-automation/merge-readiness.yaml)
...
|-----------|------------------|
| `/lgtm` command | `/lgtm` command (via `approval-labels.yaml`) |
| `/approve` command | `/approve` command (via `approval-labels.yaml`) |
